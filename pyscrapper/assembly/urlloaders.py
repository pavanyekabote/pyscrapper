...
class BrowserLessUrlLoader(UrlLoader):
    ...
    :param max_workers: Count of total number of parallel executions to be taken, while loading URL in browser.
    :param headers: This allows to set the request headers.
